...
$(function() {
    ...
    var meta = {
        types: {
            twitter: '<div class="control-group"><label class="control-label" for="tweetid">Tweet ID</label><div class="controls"><input type="text" name="tweetid" id="tweetid" class="input-large"/></div></div>',
