...
$(function() {
    ...
    var meta = {
        types: {
            ...
            picture: '<div class="control-group"><label class="control-label" for="picurl">Picture URL</label><div class="controls" id="picbox"><input type="text" name="picurl" id="picurl" class="input-large"/></div></div><div class="control-group"><label class="control-label" for="picurl">Or, upload one</label><div class="controls"><input id="imageupload" name="file_upload" type="file" /> (max size 50mb)</div></div>',
